...
Following examples are rollouts of an Octo policy trained on the Bridge dataset using the labels generated by NILS. Both real-world and simulation (using SimplerEnv) rollouts were performed.
